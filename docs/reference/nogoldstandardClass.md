...
`meddecide::nogoldstandardBase` -\> `nogoldstandardClass`

## Methods

### Public methods

- [`nogoldstandardClass$clone()`](#method-nogoldstandardClass-clone)
...
- [`meddecide::nogoldstandardBase$initialize()`](https://www.serdarbalci.com/meddecide/reference/nogoldstandardBase.html#method-initialize)
...
#### Usage
    ...
    nogoldstandardClass$clone(deep = FALSE)
