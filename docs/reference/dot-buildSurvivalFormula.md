...
[`.escapeVariableNames()`](https://www.serdarbalci.com/meddecide/reference/dot-escapeVariableNames.md)
and safe parsing via
[`.asSurvivalFormula()`](https://www.serdarbalci.com/meddecide/reference/dot-asSurvivalFormula.md).
