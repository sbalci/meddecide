# meddecide: Introduction to Medical Decision Analysis
...
meddecide is part of the comprehensive ClinicoPath suite and provides
specialized tools for medical decision analysis.
