...
modality comparison functions in meddecide, specifically designed for
digital pathology validation studies. These tools were developed based
on the methodology from Xiao et al. (2025), who studied inter-observer
variability in manual scoring of HER2 immunohistochemical stains on
glass slides versus paired digital images.
...
The `modalitycomparison` function provides specialized analysis for
digital pathology validation: - Glass slide vs digital image
comparison - HER2 5-category scoring support (Null, Ultralow, 1+, 2+,
3+) - Discordance pattern analysis with clinical significance
...
This example replicates the inter-observer agreement analysis from the
original study.
...
**Key Results from Original Study:** - Inter-observer agreement: κ =
0.82-0.87 (near perfect) - Perfect concordance (3/3): 65.2% of cases
(glass slides) - Low-end spectrum agreement: κ = 0.66-0.70 (substantial)

## Example 2: Glass Slides vs Digital Images Comparison

This example demonstrates the core finding of the original study -
comparing agreement between glass slides and digital images.
...
**Key Findings Replicated:** - Overall concordance: 89.9% (matches
original study) - Discordant cases: 10.1% (56 higher on digital, 19
higher on glass) - Highest discordance in null (19.4%) and ultralow
(15.7%) cases - Digital images showed higher sensitivity at low staining
levels

## Example 3: HER2-Low and Ultralow Category Analysis

Focus analysis on the clinically critical distinction between HER2-null
and HER2-ultralow categories.
...
- **Digital Pathology Transition**: Validate that digital scoring
  maintains diagnostic accuracy
- **Inter-observer Standardization**: Identify pathologists needing
  additional training
- **HER2-Low Detection**: Ensure reliable identification of ADC therapy
  candidates

### Quality Assurance

- **Consensus Panels**: Automate consensus determination for tumor
  boards
- **Discordance Investigation**: Identify systematic scoring differences
- **Training Assessment**: Evaluate pathologist performance on
  challenging cases
...
For ordered categories (HER2 scores), weighted kappa accounts for degree
of disagreement:
...
Systematic evaluation of whether one modality consistently scores
higher:
...
Xiao, A., Vohra, P., Chen, Y. Y., Ung, L., Kim, M. O., & Geradts, J.
(2025). Comparative study of intra- and inter-observer variability in
manual scoring of HER2 immunohistochemical stains on glass slides versus
paired digital images with emphasis on the low end of the expression
spectrum. *Human Pathology*, 161, 105860.

## Additional Resources

- [ClinicoPath Documentation](https://www.serdarbalci.com/meddecide/)
- [Digital Pathology
  Guidelines](https://www.cap.org/protocols-and-guidelines)
- [HER2 Testing
  Guidelines](https://www.asco.org/practice-clinical-research/clinical-practice-guidelines)

------------------------------------------------------------------------

*This vignette was created to demonstrate digital pathology validation
capabilities in meddecide v2.0+*
